        ...
        let
          ...
          codexPatch = (
            pkgs.fetchpatch {
              ...
              url = "https://raw.githubusercontent.com/hellodword/agents-misc/refs/heads/master/codex/patches/rust-v0.140.0/openai-provider-network-timeouts.patch";
              hash = "sha256-AYMvxvl2HhPUb/MSYuCE1l2mwq3EhkVjAQySm7T5znU=";
            }
          );
        in
        {
