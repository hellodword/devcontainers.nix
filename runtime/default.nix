...
in
{
  "devcontainer-entrypoint" = writeShellApp "devcontainer-entrypoint" [ pkgs.coreutils ] ./devcontainer-entrypoint/main.sh;
  "devcontainer-task-runner" =
    writeShellApp "devcontainer-task-runner" [
      pkgs.bash
      pkgs.coreutils
      pkgs.findutils
      pkgs.gnugrep
  ...
  "vscode-extension-projector" =
    writeShellApp "vscode-extension-projector" [
      pkgs.bash
      pkgs.coreutils
      pkgs.findutils
      pkgs.gnugrep
  ...
  "devcontainer-image" =
    writeShellApp "devcontainer-image" [
      pkgs.bash
      pkgs.coreutils
      pkgs.diffutils
      pkgs.gnugrep
