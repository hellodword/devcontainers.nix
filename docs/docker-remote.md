...
For cross-machine access, use SSH forwarding, a secure proxy, or a managed Docker endpoint with authentication and network policy. Do not expose an unauthenticated Docker TCP socket on a shared or public network.
